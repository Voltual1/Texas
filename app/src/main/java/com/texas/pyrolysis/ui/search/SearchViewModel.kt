...
package com.texas.pyrolysis.ui.search
...
sealed class SearchResultItem {
    ...
    data class HistoryItem(val history: com.texas.pyrolysis.ui.community.BrowseHistory) : SearchResultItem()
    data class LogItem(val log: com.texas.pyrolysis.data.db.LogEntry) : SearchResultItem()
}
